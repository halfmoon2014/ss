...
public partial class web_sp_hang_plate_prt : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string str_sql = "select a.id,x.khmc,a.remark,r.name createor, convert(varchar(10),a.BizDate ,120) BizDate,a.create_date,a.number,a.customer_id,a.createor_id,x.khdm,a.Audit_Status" +
        " from _v_hang_plate a" +
        " inner join v_sp_xskhda x on a.customer_id = x.id" +
        " INNER JOIN v_user r ON r.id = a.createor_id" +
        " where a.id = {0};" +
        " SELECT a.mxid,a.product,a.colour,a.weight,a.count_pre_jin,a.price,CONVERT( DECIMAL(12,2), a.price*a.weight*a.count_pre_jin,2) Amount," +
