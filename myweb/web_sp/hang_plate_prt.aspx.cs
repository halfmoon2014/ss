...
public partial class web_sp_hang_plate_prt : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        " where a.id = {0};" +
        " SELECT after_quantity=a.weight*a.count_pre_jin,a.mxid,a.product+ case when a.memory='' then '' else '['+a.memory+']' end as product ,a.colour,a.weight,a.count_pre_jin ,a.price , CASE ZB.DJLX WHEN  410 THEN CONVERT( DECIMAL(12,2), a.price*a.weight,2) ELSE  CONVERT( DECIMAL(12,2), a.price*a.weight*a.count_pre_jin,2) END  Amount," +
