define(["jquery",  "myweb", "swalProcess",'easyui'], function ($,  myweb, swalProcess) {
    var start = function () {
        ...
        $("#del").bind("click", function () {
            if ($('#xx').tree("getSelected") != null) {
                ...
                if ($('#xx').tree("getSelected").id == "-1") {//没有大类自动生成                
                    swalProcess.sAlert("不能删除这个大类!");
                } else if ($('#xx').tree("getSelected").attributes.xjbs == "1") {//有下级              
                    swalProcess.sAlert("此大类有下级类别,不能删除!");
                } else {
                        ...
                        if (r.r == 'true' && r.msg == "null") {
                            ...
                            if (id == "") {
                                ...
                                if (r == -1) {
                                    ...
                                    if (r.r == 'true') {
                                        swalProcess.sAlert('删除成功!', 'success', function () {
                                            $('#del').removeAttr("disabled")
                                            $('#xx').tree("reload");
                                        });
                            ...
                            swalProcess.sAlert("已经被产品档案引用,不能删除", function () {
                                $('#del').removeAttr("disabled")
                            });
                        }
                    }
                ...
                swalProcess.sAlert('提示信息', '请先选择一个大类!');
            }
        });
        $('#xx').tree({
