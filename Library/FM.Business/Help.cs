...
namespace FM.Business
{
    public  class Help
    {
        ...
        {
            return "<div id='Loading' algin='center' style=\"position:absolute;z-index:1000;top:0px;left:0px;width:100%;height:100%;background:#DDDDDB ;text-align:center;padding-top: 5%;\"><table style='width:100%' ><tr><td>&nbsp;</td><td style='width:20px'><img src='../images/loading.gif'/></td><td style='width:58px'><font color=\"#15428B\" style='font-size: 12px;'>加载中···</font></td><td>&nbsp;</td></tr></table></div>";
        }
    }
